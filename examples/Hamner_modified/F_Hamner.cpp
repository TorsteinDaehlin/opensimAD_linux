...
int F_generic(const T** arg, T** res) {
	...
	SmoothSphereHalfSpaceForce_s1_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s1_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s1_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s2_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s2_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s2_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s3_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s3_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s3_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s4_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s4_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s4_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s5_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s5_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s5_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s6_r->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s6_r->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s6_r->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s1_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s1_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s1_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s2_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s2_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s2_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s3_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s3_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s3_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s4_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s4_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s4_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s5_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s5_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s5_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	SmoothSphereHalfSpaceForce_s6_l->set_constant_contact_force(0.00001000000000000000);
	SmoothSphereHalfSpaceForce_s6_l->set_hertz_smoothing(300.00000000000000000000);
	SmoothSphereHalfSpaceForce_s6_l->set_hunt_crossley_smoothing(50.00000000000000000000);
	...
	Vec3 Point_back_push = Vec3(-0.10000000000000000555, 0.29999999999999998890, 0.00000000000000000000);
	Vec3 Force_back_push;	for (int i = 0; i < 3; ++i) Force_back_push[i] = u[31+i];
	Vec3 Force_back_push_inG = Force_back_push;
	model->getMatterSubsystem().addInStationForce(*state, torso->getMobilizedBodyIndex(), Point_back_push, Force_back_push_inG, appliedBodyForces);

	/// moments acting on bodies
	Vec3 Moment_exo_shank_l;
	for (int i = 0; i < 3; ++i) Moment_exo_shank_l[i] = u[34+i];
	Vec3 Moment_exo_shank_l_inG = tibia_l->getMobilizedBody().expressVectorInGroundFrame(*state, Moment_exo_shank_l);
	model->getMatterSubsystem().addInBodyTorque(*state, tibia_l->getMobilizedBodyIndex(), Moment_exo_shank_l_inG, appliedBodyForces);

	Vec3 Moment_exo_foot_l;
	for (int i = 0; i < 3; ++i) Moment_exo_foot_l[i] = u[37+i];
	Vec3 Moment_exo_foot_l_inG = tibia_l->getMobilizedBody().expressVectorInGroundFrame(*state, Moment_exo_foot_l);
	model->getMatterSubsystem().addInBodyTorque(*state, calcn_l->getMobilizedBodyIndex(), Moment_exo_foot_l_inG, appliedBodyForces);
	...
	/// Station locations.
	Vec3 left_shin_posInGround = tibia_l->findStationLocationInGround(*state, Vec3(0.00000000000000000000, -0.01200000000000000025, 0.00000000000000000000));
	Vec3 right_shin_posInGround = tibia_r->findStationLocationInGround(*state, Vec3(0.00000000000000000000, -0.01200000000000000025, 0.00000000000000000000));

	/// Station velocities.
	Vec3 left_shin_velInGround = tibia_l->findStationVelocityInGround(*state, Vec3(0.00000000000000000000, -0.01200000000000000025, 0.00000000000000000000));
	...
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 3] = value<T>(right_shin_posInGround[i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 6] = value<T>(left_shin_velInGround[i]);
	/// Ground reaction forces.
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 9] = value<T>(GRF_r[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 12] = value<T>(GRF_l[1][i]);
	/// Separate Ground reaction forces.
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 15] = value<T>(GRF_0[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 18] = value<T>(GRF_1[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 21] = value<T>(GRF_2[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 24] = value<T>(GRF_3[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 27] = value<T>(GRF_4[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 30] = value<T>(GRF_5[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 33] = value<T>(GRF_6[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 36] = value<T>(GRF_7[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 39] = value<T>(GRF_8[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 42] = value<T>(GRF_9[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 45] = value<T>(GRF_10[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 48] = value<T>(GRF_11[1][i]);
	/// Ground reaction moments.
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 51] = value<T>(GRM_r[1][i]);
	for (int i = 0; i < 3; ++i) res[0][i + nCoordinates + 54] = value<T>(GRM_l[1][i]);
	/// Contact spheres deformation power.
	res[0][nCoordinates + 57] = value<T>(P_HC_y_0);
	res[0][nCoordinates + 58] = value<T>(P_HC_y_1);
	res[0][nCoordinates + 59] = value<T>(P_HC_y_2);
	res[0][nCoordinates + 60] = value<T>(P_HC_y_3);
	res[0][nCoordinates + 61] = value<T>(P_HC_y_4);
	res[0][nCoordinates + 62] = value<T>(P_HC_y_5);
	res[0][nCoordinates + 63] = value<T>(P_HC_y_6);
	res[0][nCoordinates + 64] = value<T>(P_HC_y_7);
	res[0][nCoordinates + 65] = value<T>(P_HC_y_8);
	res[0][nCoordinates + 66] = value<T>(P_HC_y_9);
	res[0][nCoordinates + 67] = value<T>(P_HC_y_10);
	res[0][nCoordinates + 68] = value<T>(P_HC_y_11);
